...
/////////////////////////////////////
/* Problem 2
Write a function called multiply() that takes in two numbers as arguments and returns an array where the first element is the product of those numbers, and the second element is a string that EXACTLY follows this example and uses the values that were input into the function: "The product of 5 and 9 is 45."
...
IMPORTANT DETAIL: You may not use the arithmetic operators + and * in this function. To do addition,
 use your sum() function, and to do multiplication, use your multiply() function that you've already
  created. You're going to have to be resourceful to figure out how to do this. However, you may continue
...
var sumThreeNumbers = sum(sum(a,b)[0],c)[0];
var multiplyThreeNumbers = multiply(multiply(a,b)[0],c)[0];  
var resultStringsum = a +' and '+ b + ' and '+ c +' sum to '+ sumThreeNumbers +'.';
var resultStringmultiply ='The product of '+a+' and '+b+' and '+c+' is '+multiplyThreeNumbers+'.';
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for(var  i = 0 ; i < testDynamicArray.length ; i++){
    multiplyOfArray= multiply(multiplyOfArray,testDynamicArray[i])[0];
  }
  
var resultString ='The numbers '+ testDynamicArray.toString() +' have a product of '+multiplyOfArray+'.';
return [ multiplyOfArray,resultString];
}
